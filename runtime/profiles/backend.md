...
- One capability page owns one immutable Capability ID and records the
  team-local artifact revision. A consumer-facing cross-team handoff is a
  self-contained Confluence contract snapshot, including the public API or
